...
import (
	"github.com/yu-gopass/svc/domain/model"
	"github.com/yu-gopass/svc/domain/repository"
	"k8s.io/api/apps/v1"
...
func NewSvcDataService(svcRepository repository.ISvcRepository,clientSet *kubernetes.Clientset) ISvcDataService{
	return &SvcDataService{ SvcRepository:svcRepository, K8sClientSet: clientSet,deployment:&v1.Deployment{}}
}
